...
/**
 * This class represents a german-english translator. Contains a set of dictionary entries.
 * @author Dushan Terzikj 30001357, Dragi Kamov 30001478, Fanlin Wang 30000522, Sajit Kunwar 20331648
 * @since 30.03.2018 
 */
public class GermanEnglishTranslator implements Translator{
     ...
     */
    public GermanEnglishTranslator(){

        data = new HashMap<String, DictEntry>();
        BufferedReader bReader = null;
        try {
            bReader = new BufferedReader(new FileReader("en2de.txt"));
            String line = "";
